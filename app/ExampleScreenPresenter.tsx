...
interface SegmentsExtraOptions {
  ...
  setState?: React.Dispatch<
    React.SetStateAction<any /** no suitable solution for enum */>
  >;
}
...
export function renderBooleanOption(
  title: string,
  key: string,
  { spread, afterValueChanged, state, setState }: BooleanGroupOptions = {
    spread: true,
  }
) {
  // @ts-ignore
...
export function renderColorOption(
  title: string,
  key: string,
  colors = [
    "transparent",
...
export function renderSliderOption(
  title: string,
  key: string,
...
export function renderMultipleSegmentOptions(
  title: string,
  key: string,
